...
/**
 * An unresolved reference to an external data source.
 *
 ...
 */
public record UnresolvedSource(
    String type,
    ...
    /**
     * Create an unresolved source from a registered data source.
     *
     ...
     * @param source Source location for error reporting
     */
    public static UnresolvedSource registered(
        String dataSourceName,
        String type,
        Map<String, Object> configuration,
        Map<String, Object> settings,
        ...
        return new UnresolvedSource(type, configuration, settings, expression, dataSourceName, source);
    }

    /**
     * Create an unresolved source from an inline definition.
     *
     ...
     * @param source Source location for error reporting
     */
    public static UnresolvedSource inline(
        String type,
        Map<String, Object> configuration,
        Map<String, Object> settings,
        String expression,
        ...
        return new UnresolvedSource(type, configuration, settings, expression, null, source);
    }
